...
urlpatterns = [
    ...
    path("password_reset_confirm/", views_auth.PasswordResetConfirmView.as_view(), name="auth_password_reset_confirm"),
    path("password_change/", views_auth.PasswordChangeView.as_view(), name="auth_password_change"),
]